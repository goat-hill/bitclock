...
export default function Terms() {
  return (
    <Container py="md">
      ...
      <p>Last Update: June 3, 2024</p>

      <Title order={2}>OVERVIEW</Title>
      <p>
        This website is operated by Goat Hill Electronics LLC. Throughout the
        site, the terms &ldquo;Bitclock&rdquo;, &ldquo;we&rdquo;,
        &ldquo;us&rdquo; and &ldquo;our&rdquo; refer to Goat Hill Electronics
        LLC. Bitclock offers this website, including all information, tools and
      ...
      <Title order={2}>SECTION 1 - ONLINE STORE TERMS</Title>
      <p>
      ...
      <Title order={2}>SECTION 2 - GENERAL CONDITIONS</Title>
      <p>
      ...
      <Title order={2}>SECTION 5 - PRODUCTS</Title>
      <p>
      ...
      <p>
        Our products are designed to be fun gadgets for hobbyists and
        enthusiasts. Please be aware that the accuracy of the sensor
        measurements provided by our products are not guaranteed and may vary.
        This product should not be relied upon for health or safety purposes. It
        is not intended for professional or medical use, and any data provided
        by the device should be treated as approximate.
      </p>

      <p>
        By using this product, you acknowledge and agree that it is not suitable
        for use in situations where precise sensor readings are required. We are
        not responsible for any harm or damages resulting from the use of this
        product for health, safety, or any other critical purposes.
      </p>
      ...
      <p>
        ...
        limit the quantities of any products that we offer. All descriptions of
      ...
      <Title order={2}>SECTION 7 - OPTIONAL TOOLS</Title>
      <p>
      ...
      <Title order={2}>SECTION 8 - THIRD-PARTY LINKS</Title>
      <p>
      ...
      <Title order={2}>SECTION 10 - PERSONAL INFORMATION</Title>
      <p>
      ...
      <Title order={2}>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</Title>
      <p>
      ...
      <Title order={2}>SECTION 12 - PROHIBITED USES</Title>
      <p>
      ...
      <p>
        In no case shall Bitclock, our directors, officers, employees,
      ...
      <Title order={2}>SECTION 14 - INDEMNIFICATION</Title>
      <p>
        You agree to indemnify, defend and hold harmless Bitclock and our
      ...
      <Title order={2}>SECTION 15 - SEVERABILITY</Title>
      <p>
      ...
      <Title order={2}>SECTION 16 - TERMINATION</Title>
      <p>
      ...
      <Title order={2}>SECTION 17 - ENTIRE AGREEMENT</Title>
      <p>
      ...
      <Title order={2}>SECTION 18 - GOVERNING LAW</Title>
      <p>
      ...
      <Title order={2}>SECTION 19 - CHANGES TO TERMS OF SERVICE</Title>
      <p>
      ...
      <Title order={2}>SECTION 20 - CONTACT INFORMATION</Title>
      <p>
        Questions about the Terms of Service should be sent to us at{" "}
        <Anchor component={Link} href="mailto:terms@bitclock.io">
          terms@bitclock.io
        </Anchor>
        .
      </p>
