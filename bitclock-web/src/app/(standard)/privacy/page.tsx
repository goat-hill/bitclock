...
export default function Privacy() {
  return (
    <>
      ...
      <p>
        This Privacy Policy describes how Bitclock (the &quot;Site&quot;,
        &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) collects, uses, and
        discloses your personal information when you visit, use our services, or
        make a purchase from bitclock.io (the &quot;Site&quot;) or otherwise
      ...
      <Title order={2}>How We Collect and Use Your Personal Information</Title>
      <p>
      ...
      <Title order={3}>What Personal Information We Collect</Title>
      <p>
      ...
      <Title order={3}>Information We Collect Directly from You</Title>
      <p>
      ...
      <ul>
        ...
        <li>
          Shopping information including the items you view, put in your cart or
      ...
      <Title order={3}>Information We Collect through Cookies</Title>
      <p>
      ...
      <Title order={3}>Information We Obtain from Third Parties</Title>
      <p>
      ...
      <ul>
        <li>Companies who support our Site and Services, such as Stripe.</li>
        <li>
      ...
      <p>
        ...
        are not responsible for any third party&apos;s policies or practices.
        For more information, see the section below, Third Party Websites and
        Links.
      </p>

      <Title order={3}>How We Use Your Personal Information</Title>
      <ul>
        <li>
          ...
          notifications to you related to you account, purchases, returns,
        ...
        <li>
          Communicating with you. We use your personal information to provide
          you with customer support and improve our Services. This is in our
      ...
      <p>
        ...
        and improve our Site and our Services (including to remember your
        actions and preferences), to run analytics and better understand user
      ...
      <Title order={2}>How We Disclose Personal Information</Title>
      <p>
      ...
      <ul>
        ...
        <li>
          With business and marketing partners, including Stripe, to provide
      ...
      <Title order={2}>User Generated Content</Title>

      <p>
        The Services may enable you to post reviews and other user-generated
      ...
      <Title order={2}>Third Party Websites and Links</Title>
      <p>
      ...
      <Title order={3}>Children’s Data</Title>
      <p>
      ...
      <Title order={3}>Security and Retention of Your Information</Title>
      <p>
      ...
      <ul>
        ...
        <li>
          Restriction of Processing: You may have the right to ask us to stop or
          restrict our processing of personal information.
        </li>
        <li>
      ...
      <p>
        If we transfer your personal information out of Europe, we will rely on
        recognized transfer mechanisms like the European Commission&apos;s
        Standard Contractual Clauses, or any equivalent contracts issued by the
        relevant competent authority of the UK, as relevant, unless the data
      ...
      <p>
        ...
        <a href="mailto:privacy@bitclock.io">privacy@bitclock.io</a>.
      </p>
    </>
  );
}
