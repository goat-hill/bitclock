...
The sensors from Sensirion claim to be "factory calibrated", but don't expect perfect accuracy from them.

I've made best efforts to follow datasheet recommendations for getting accurate readings from the sensors. In my DIY testing,
they all seem responsive to environmental changes but accuracy is not guaranteed.

Specifically, in my testing the temperature readings from the SHT41 were typically \~4°C too hot. In this case, the offset seems consistent so I added an [offset to the measurement](https://github.com/goat-hill/bitclock/blob/a495f9582fb3601ba604b6d4db3fd6bbdfef9350/bitclock-fw/main/tasks/sht4x.c#L98-L112).

Sensor details from Sensirion:

- [SHT41 ±1.8% / max. ±2.5% RH Digital humidity and temperature sensor](https://sensirion.com/products/catalog/SHT41)
