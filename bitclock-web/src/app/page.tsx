    ...
    <Container py="md">
      <Box style={{ marginLeft: "auto", marginRight: "auto" }}>
        ...
        <Flex direction="column" mt="md" align="center" gap="md">
          ...
          <Text ta="center">
            Shipping <strong>July 2024</strong>. Complete the form to be
            notified when it&apos;s available!
          </Text>
          <Box w={{ base: "100%", xs: 480, md: 600 }}>
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLSd2UAob-NJfPU_3VcjZiAaslMEGd6qegJ8XPgLOtxQYYuO0Aw/viewform?embedded=true"
              width="100%"
              height="1500"
              frameBorder={0}
              marginHeight={0}
