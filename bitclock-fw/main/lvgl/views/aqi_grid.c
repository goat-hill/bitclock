...
void lv_helper_aqi_grid_create() {
  ...
  create_label(screen, "CO2", LV_TEXT_ALIGN_LEFT, LV_GRID_ALIGN_START, 0, 1);
  create_label(screen, "VOC", LV_TEXT_ALIGN_LEFT, LV_GRID_ALIGN_START, 0, 2);
  create_label(screen, "NOx", LV_TEXT_ALIGN_LEFT, LV_GRID_ALIGN_START, 0, 3);
...
void lv_helper_aqi_grid_update(lv_helper_view_mode_aqi_data_t *data) {
  ...
  static char nox_str[10];
  snprintf(nox_str, sizeof(nox_str), "%" PRId32, data->nox_index);
  set_text_if_changed(nox_label, nox_str);
}
