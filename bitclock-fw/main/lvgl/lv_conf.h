 ...
 */
#define LV_DRAW_THREAD_STACK_SIZE    (3 * 1024)   /*[bytes]*/
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(sublabel)

/*Always set a default font*/
#define LV_FONT_DEFAULT &sublabel
